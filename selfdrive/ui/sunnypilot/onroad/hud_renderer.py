...
from openpilot.selfdrive.ui.sunnypilot.onroad.nav_instruction import NavInstructionRenderer
...
class HudRendererSP(HudRenderer):
  def __init__(self):
    ...
    self.nav_instruction_renderer = NavInstructionRenderer()
  ...
  def _update_state(self) -> None:
    ...
    self.nav_instruction_renderer.update()
  ...
  def _render(self, rect: rl.Rectangle) -> None:
    ...
    self.nav_instruction_renderer.render(rect)
